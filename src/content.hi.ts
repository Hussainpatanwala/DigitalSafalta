...
export const content: SiteContent = {
  ...
  hero: {
    ...
    growthHooksHeading: "छोटे व्यवसाय मालिक हमसे जो सवाल पूछते हैं",
    growthHooksSubheading: "सीधे जवाब — कोई मुश्किल शब्दजाल नहीं, कोई अंदाज़ा नहीं।",
    growthHooksCtaText: "पोस्टिंग प्लान्स देखें",
    growthHooksCtaSubtext: "₹1,000/माह से शुरू",
    growthHooks: [
      {
        question: "मैं रोज़ पोस्ट करता हूं, फिर भी ग्राहक नहीं बन रहे। क्या गलत हो रहा है?",
        answer: "पोस्ट करने से आप दिखते तो रहते हैं, लेकिन सिर्फ दिखने से बिक्री नहीं होती — जब कोई आपको नोटिस करे, उसके बाद क्या होता है यह उतना ही ज़रूरी है: तेज़ जवाब, साफ ऑफर, आप तक पहुंचने का आसान तरीका। हमारी पोस्टिंग प्लान्स ठीक इसी के लिए बनी हैं — लगातार कंटेंट, साथ में ध्यान को पूछताछ में बदलने की योजना।",
      },
      {
        question: "लोग दाम पूछकर चुप हो जाते हैं। इन्हें खोने से कैसे बचूं?",
        answer: "ज़्यादातर मामलों में असली वजह दाम नहीं, बल्कि आपके जवाब की रफ़्तार होती है। ग्राहक आमतौर पर उसी के पास जाता है जो सबसे पहले जवाब दे, इसलिए देर से या छूटा हुआ जवाब दाम से ज़्यादा बिक्री गंवा देता है। हमारी प्लान्स में जवाब देने का सही तरीका भी शामिल है, ताकि कोई ग्राहक इंतज़ार में न रहे।",
      },
      {
        question: "मेरे आसपास 3-4 वैसी ही दुकानें हैं — लोग मुझे ही क्यों चुनें?",
        answer: "सबसे बड़ा या सबसे सस्ता होने से ज़्यादा मायने रखता है ऑनलाइन सक्रिय और जवाबदेह होना — असली रिव्यूज़ और हाल की पोस्ट्स के साथ। यही एक नए ग्राहक को भरोसे के साथ अंदर आने लायक बनाता है। हमारी पोस्टिंग प्लान्स आपकी प्रोफ़ाइल को लगातार सक्रिय रखती हैं, ताकि आप ही स्पष्ट और भरोसेमंद विकल्प बनें।",
      },
      {
        question: "मेरे रील्स पर व्यूज़ आते हैं, लेकिन नए ग्राहक नहीं आते। क्यों?",
        answer: "व्यूज़ दिलचस्पी दिखाते हैं, भरोसा नहीं। किसी को असल में आने के लिए हाल की, अच्छी रिव्यूज़ वाली प्रोफ़ाइल और आज ही आने की एक साफ वजह चाहिए होती है। हमारी प्लान्स ऐसे कंटेंट पर ध्यान देती हैं जो यह भरोसा बनाए, न कि सिर्फ अच्छे दिखने वाले आंकड़े।",
      },
      {
        question: "मुझे कैसे पता चलेगा कि यह असल में काम कर रहा है?",
        answer: "आपको हर महीने एक सीधी-सादी रिपोर्ट मिलेगी — कितने लोगों ने आपकी पोस्ट देखीं, कौन सी पोस्ट सबसे अच्छी रही, और कितनी पूछताछ आईं। कोई मुश्किल शब्दजाल नहीं, बस ऐसे आंकड़े जिन पर आप काम कर सकें। यह हर पोस्टिंग प्लान में शामिल है।",
      },
      {
        question: "सबसे पहले क्या ठीक करना चाहिए?",
        answer: "एक पूरी, सक्रिय प्रोफ़ाइल — Google Business Profile, Instagram और Facebook — हाल की पोस्ट्स और जवाबों के साथ। यही वह सबसे बड़ी चीज़ है जो लोगों को आपके पास आने लायक भरोसा दिलाती है। हमारी पोस्टिंग प्लान्स ठीक यहीं से शुरू होती हैं।",
      },
    ],
  },
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        currency: "₹",
        period: "one-time",
        description: "आपके workflow के लिए एक कस्टम, database-backed वेब ऐप — जो एक static साइट नहीं कर सकती",
        features: [
          "आपके workflow के अनुसार कस्टम-निर्मित — forms, records, dashboards",
          "आपका डेटा मैनेज करने के लिए Admin panel",
          "Database-backed — डेटा सुरक्षित रूप से स्टोर होता है, सिर्फ contact form नहीं",
          "ज़रूरत होने पर User login व roles",
          "Mobile responsive डिज़ाइन",
          "SSL certificate (HTTPS) — हमेशा के लिए मुफ़्त",
          "Timeline हमारी discovery call पर scope की जाती है",
        ],
        note: "Free-tier Cloudflare storage व database पर बना। अगर यह एक public portal है जिसमें user sign-up/login चाहिए, तो हम इसके बजाय Supabase इस्तेमाल करते हैं। Email, WhatsApp, या SMS notifications — अगर आपके app को चाहिए — actual cost पर चार्ज होंगे, यह price में शामिल नहीं है।",
        highlighted: false
      },
      {
        name: "स्टार्टर ऐड्स",
  ...
  contact: {
    title: "अपना मुफ़्त मार्केटिंग ऑडिट पाएं",
    description: "अपनी मार्केटिंग के बारे में कुछ सवालों के जवाब दें। हम 24 घंटों के भीतर ईमानदार, बिना किसी बाध्यता की सलाह के साथ वापस आएंगे — चाहे हम साथ काम करें या नहीं।",
    formPlaceholder: {
      name: "आपका नाम",
      email: "आपका ईमेल",
    ...
    buttonText: "मेरा मुफ़्त ऑडिट पाएं",
