    ...
    postingPlans: [
      {
        ...
        price: "₹2,000",
        period: "/month",
        features: ["5 custom social media posts/month", "Instagram, Facebook, Google Business Profile, LinkedIn"],
      },
    ],
    dailyPlan: {
      title: "Daily Dedicated Plan",
      description: "1 hour of dedicated content creation and publishing every weekday (Mon–Fri), up to 20 posts a month across Instagram, Facebook, Google Business Profile, and LinkedIn.",
      features: [
        "Up to 20 posts/month across 4 platforms",
        "Content tailored to your brand",
        "Professional design + captions",
        "Consistent daily posting to keep your audience engaged",
      ],
    },
  },
  hi: {
    ...
    postingPlans: [
      {
        ...
        price: "₹2,000",
        period: "/महीना",
        features: ["5 कस्टम सोशल मीडिया posts/महीना", "Instagram, Facebook, Google Business Profile, LinkedIn"],
      },
    ],
    dailyPlan: {
      title: "Daily Dedicated Plan",
      description: "हर weekday (सोम–शुक्र) 1 घंटा dedicated content creation और publishing, Instagram, Facebook, Google Business Profile, और LinkedIn पर महीने में 20 posts तक।",
      features: [
        "4 platforms पर महीने में 20 posts तक",
        "आपके brand के अनुसार content",
        "Professional design + captions",
        "आपकी audience को engaged रखने के लिए लगातार रोज़ाना posting",
      ],
    },
  },
  mr: {
    ...
    postingPlans: [
      {
        ...
        price: "₹2,000",
        period: "/महिना",
        features: ["5 कस्टम सोशल मीडिया posts/महिना", "Instagram, Facebook, Google Business Profile, LinkedIn"],
      },
    ],
    dailyPlan: {
      title: "Daily Dedicated Plan",
      description: "प्रत्येक weekday (सोम–शुक्र) 1 तास dedicated content creation आणि publishing, Instagram, Facebook, Google Business Profile, आणि LinkedIn वर महिन्याला 20 posts पर्यंत.",
      features: [
        "4 platforms वर महिन्याला 20 posts पर्यंत",
        "तुमच्या brand नुसार content",
        "Professional design + captions",
        "तुमच्या audience ला engaged ठेवण्यासाठी सातत्यपूर्ण दररोज posting",
      ],
    },
  },
};
