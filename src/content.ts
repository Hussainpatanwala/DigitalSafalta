/**
 * ===================================================================
 * DIGITAL SAFALTA - WEBSITE CONTENT
 * ===================================================================
 * Edit the values below to update your site content.
 * ===================================================================
 */
...
export const contactTitle = "Let's Talk About Your Business";
export const contactDescription = "Tell us about your business and goals. We will get back to you within 24 hours with honest advice — whether or not we end up working together.";
...
export const contactResponseTime = "We respond within 24 hours — usually much faster.";
...
export const heroImageId = "3184291";
